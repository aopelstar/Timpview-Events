            ...
            <div>
                ...
                <div className='songs'>
                    <div className='edit-rows' onClick={() => this.handleChange("groomTrue")}>Groom: <div className={this.state.groomTrue? 'edit-desc-text' : 'edit-desc-textH'}>
                        <input className="edit-input" value={this.props.groom_name} onChange={(e) => this.handleChange("groom", e.target.value)} />
                        </div>
                    ...
                    <div className='edit-rows' onClick={() => this.handleChange("brideTrue")}>Bride: <div className={this.state.brideTrue ? 'edit-desc-text' : 'edit-desc-textH'}>
                        <input className="edit-input" value={this.props.bride_name} onChange={(e) => this.handleChange("bride", e.target.value)} />
                        </div>
                    ...
                    <div className='edit-rows' onClick={() => this.handleChange('gphoTrue')}>Groom's Phone: <div className={this.state.gphoTrue ? 'edit-desc-text' : 'edit-desc-textH'}>
                        <input className="edit-input" value={this.props.g_phone} onChange={(e) => this.handleChange("gPhone", e.target.value)}/>
                        </div>
                        ...
                        <input className="edit-input" value={this.props.b_phone} onChange={(e) => this.handleChange("bPhone", e.target.value)}/>
                        </div>
                    ...
                    <div className='edit-rows' onClick={() => this.handleChange('dateTrue')}>Date: <div className={this.state.dateTrue ? 'edit-desc-text' : 'edit-desc-textH'}>
                        <input className="edit-input" value={this.props.date} onChange={(e) => this.handleChange("date", e.target.value)}/>
                        </div>
                    ...
                    <div className='edit-rows' onClick={() => this.handleChange('timeTrue')}>Time: <div className={this.state.timeTrue ? 'edit-desc-text' : 'edit-desc-textH'}>
                        <input className="edit-input" value={this.props.time} onChange={(e) => this.handleChange("time", e.target.value)}/>
                        </div>
                    ...
                    <div className='edit-rows' onClick={() => this.handleChange('venueTrue')}>Venue: <div className={this.state.venueTrue ? 'edit-desc-text' : 'edit-desc-textH'}>
                        <input className="edit-input" value={this.props.venue} onChange={(e) => this.handleChange("venue", e.target.value)}/>
...
export default connect( mapStateToProps, {updateEvent, getUser} ) (EditEvent);